...
if __name__ == '__main__':
    ...
    origin_wavpath_default = "./dataset/VCTK-Corpus/wav48"
    target_wavpath_default = "./dataset/VCTK-Corpus/wav16"
    mc_dir_train_default = './dataset/mc/train'
    mc_dir_test_default = './dataset/mc/test'
